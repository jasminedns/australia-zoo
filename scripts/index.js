...
const animals = {
    ...
    tasmanianDevil: {
        ...
        length: "70cm",
        weight: "10kg",
        image: "../image/transparent-img/tasmanian-devil.png."
    },
...
//Repitiles
 ...
 //birds
    cassowary: {
        ...
        fulldescription:    `They are strong swimmers and can move quickly on both land and water. Cassowaries are shy and 
    ...
    kookaburra: {
        ...
        shortDescription:   `Native to the eucalyptus forests of eastern Australia, the laughing kookaburra is the largest 
                            ...
                            in length.`,
        fulldescription:    `Its beak can reach 10 cm long and is used to snatch a variety of invertebrates and 
    ...
    yellowTailedBlackCockatoo: {
        ...
        fulldescription:    `The adult male has a black beak and pinkish-red 
...
function updateContent(animal = null) {
    ...
    if (animal) {
        ...
        animalSummary.textContent = animal.shortDescription;
    } else {
